...
public class MvcControllerIntegTestHelpers {
  ...
  // makes a certain number of deposits to a customer's account
  public static void makeDeposits(MvcController controller, User depositForm, double deposits[]) {
    for (int i = 0; i < deposits.length; i++) {
      depositForm.setAmountToDeposit(deposits[i]);
