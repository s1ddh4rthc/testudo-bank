...
public class MvcControllerIntegTestHelpers {
  ...
  public static void addCustomerToDB(DatabaseDelegate dbDelegate, String ID, String password, String firstName, String lastName, int balance, int overdraftBalance, int numFraudReversals, int numInterestDeposits, boolean isAccountFrozen, int numAccountFrozen) throws ScriptException {
    String insertCustomerSql = String.format("INSERT INTO Customers VALUES ('%s', '%s', '%s', %d, %d, %d, %d, %b, %d)", ID, firstName, lastName, balance, overdraftBalance, numFraudReversals, numInterestDeposits, isAccountFrozen, numAccountFrozen);
