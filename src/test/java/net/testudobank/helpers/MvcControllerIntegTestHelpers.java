...
public class MvcControllerIntegTestHelpers {
  ...
  public static void addCustomerToDB(DatabaseDelegate dbDelegate, String ID, String password, String firstName, String lastName, int balance, int balanceINR, int balanceGBP, int balanceCNY, int overdraftBalance, int numFraudReversals, int numInterestDeposits) throws ScriptException {
    String insertCustomerSql = String.format("INSERT INTO Customers VALUES ('%s', '%s', '%s', %d, %d, %d, %d, %d, %d, %d)", ID, firstName, lastName, balance, balanceINR, balanceGBP, balanceCNY, overdraftBalance, numFraudReversals, numInterestDeposits);
  ...
  public static void addCustomerToDB(DatabaseDelegate dbDelegate, String ID, String password, String firstName, String lastName, int balance, int balanceINR, int balanceGBP, int balanceCNY, int interestDeposits) throws ScriptException {
    addCustomerToDB(dbDelegate, ID, password, firstName, lastName, balance, balanceINR, balanceGBP, balanceCNY, 0, 0, 0);
  }
