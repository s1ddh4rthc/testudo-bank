...
public class MvcControllerIntegTest {
    ...
    public static void testIfInterestApplied() throws SQLException, ScriptException {
        ...
        double totalDeposit = 5 * CUSTOMER1_AMOUNT_TO_DEPOSIT;
    ...
    /*
     * Simple Deposit Case where user make Euro deposit.
     */
    @Test
    public static void TestInternationalDeposit() throws SQLException, ScriptException {
        double CUSTOMER1_BALANCE = 1000;
        int CUSTOMER1_BALANCE_IN_PENNIES = MvcControllerIntegTestHelpers.convertDollarsToPennies(CUSTOMER1_BALANCE);
        MvcControllerIntegTestHelpers.addCustomerToDB(dbDelegate, CUSTOMER1_ID,
                CUSTOMER1_PASSWORD, CUSTOMER1_FIRST_NAME, CUSTOMER1_LAST_NAME,
        ...
        double CUSTOMER1_AMOUNT_TO_DEPOSIT = 200;
        double euroDeposit = 100;
        double CONVERSION_RATE = 0.90;
        User user1 = new User();
        user1.setUsername(CUSTOMER1_ID);
        user1.setPassword(CUSTOMER1_PASSWORD);
        user1.setAmountToDeposit(CUSTOMER1_AMOUNT_TO_DEPOSIT);
        user1.setAmountToDepositInEuro(euroDeposit);
        controller.submitDeposit(user1);
        double totalDeposit = user1.getAmountToDeposit() + (euroDeposit * CONVERSION_RATE);

        double CUSTOMER1_EXPECTED_FINAL_BALANCE = (CUSTOMER1_BALANCE + totalDeposit);
        double CUSTOMER1_EXPECTED_FINAL_BALANCE_IN_PENNIES = MvcControllerIntegTestHelpers
                .convertDollarsToPennies(CUSTOMER1_EXPECTED_FINAL_BALANCE);
        assertEquals(CUSTOMER1_EXPECTED_FINAL_BALANCE_IN_PENNIES, (int) user1.getBalance());
    }
    ...
    /*
     * Simple Withdraw Case where user make Euro withdrawal
     */
    @Test
    public static void TestInternationalWithdraw() throws SQLException, ScriptException {
        double CUSTOMER1_BALANCE = 1000;
        int CUSTOMER1_BALANCE_IN_PENNIES = MvcControllerIntegTestHelpers.convertDollarsToPennies(CUSTOMER1_BALANCE);
        MvcControllerIntegTestHelpers.addCustomerToDB(dbDelegate, CUSTOMER1_ID,
                CUSTOMER1_PASSWORD, CUSTOMER1_FIRST_NAME, CUSTOMER1_LAST_NAME,
        ...
        double euroWithdraw = 100;
        double CONVERSION_RATE = 0.90;
        User user1 = new User();
        user1.setUsername(CUSTOMER1_ID);
        user1.setPassword(CUSTOMER1_PASSWORD);
        user1.setAmountToWithdraw(CUSTOMER1_AMOUNT_TO_WITHDRAW);
        user1.setAmountToWithdrawInEuro(euroWithdraw);
        controller.submitWithdraw(user1);
        double totalWithdraw = user1.getAmountToDeposit() + (euroWithdraw * CONVERSION_RATE);

        double CUSTOMER1_EXPECTED_FINAL_BALANCE = (CUSTOMER1_BALANCE + totalWithdraw);
        double CUSTOMER1_EXPECTED_FINAL_BALANCE_IN_PENNIES = MvcControllerIntegTestHelpers
                .convertDollarsToPennies(CUSTOMER1_EXPECTED_FINAL_BALANCE);
        assertEquals(CUSTOMER1_EXPECTED_FINAL_BALANCE_IN_PENNIES, (int) user1.getBalance());
    }
     ...
     */
    @Test
    public static void TestInternationalDepositInvalid() throws SQLException, ScriptException {
        double CUSTOMER1_BALANCE = 1000;
        int CUSTOMER1_BALANCE_IN_PENNIES = MvcControllerIntegTestHelpers.convertDollarsToPennies(CUSTOMER1_BALANCE);
        MvcControllerIntegTestHelpers.addCustomerToDB(dbDelegate, CUSTOMER1_ID,
                CUSTOMER1_PASSWORD, CUSTOMER1_FIRST_NAME, CUSTOMER1_LAST_NAME,
        ...
        user1.setAmountToDeposit(CUSTOMER1_AMOUNT_TO_DEPOSIT);
        user1.setAmountToDepositInEuro(euroDeposit);
        String homepage = controller.submitDeposit(user1);
        assertEquals(homepage, "welcome");
    }

    /*
     * Simple Deposit Test Case to see if the interest feature is still working
     * properly
     */
    @Test
    public static void TestInternationalDepositWithInterest() throws SQLException, ScriptException {
        double CUSTOMER1_BALANCE = 1000;
        int CUSTOMER1_BALANCE_IN_PENNIES = MvcControllerIntegTestHelpers.convertDollarsToPennies(CUSTOMER1_BALANCE);
        MvcControllerIntegTestHelpers.addCustomerToDB(dbDelegate, CUSTOMER1_ID,
                CUSTOMER1_PASSWORD, CUSTOMER1_FIRST_NAME, CUSTOMER1_LAST_NAME,
        ...
        totalDeposit += 4 * CUSTOMER1_AMOUNT_TO_DEPOSIT;
        assertEquals(1800, totalDeposit + CUSTOMER1_BALANCE);
        user1.setAmountToDepositInEuro(euroDeposit);
        controller.submitDeposit(user1);

        totalDeposit += (CUSTOMER1_AMOUNT_TO_DEPOSIT + (euroDeposit * CONVERSION_RATE)) * 1.02;
    ...
    /*
     * Simple Withdraw Edge Case to see
     * if the 0 Euro Currency impact Customer Balance or not
     */
    @Test
    public static void TestInternationalWithdrawWIthZeroEuroCurrency() throws SQLException, ScriptException {
        double CUSTOMER1_BALANCE = 1000;
        int CUSTOMER1_BALANCE_IN_PENNIES = MvcControllerIntegTestHelpers.convertDollarsToPennies(CUSTOMER1_BALANCE);
        MvcControllerIntegTestHelpers.addCustomerToDB(dbDelegate, CUSTOMER1_ID,
                CUSTOMER1_PASSWORD, CUSTOMER1_FIRST_NAME, CUSTOMER1_LAST_NAME,
        ...
        double CUSTOMER1_AMOUNT_TO_WITHDRAW = 200;
        double euroWithdraw = 0;
        User user1 = new User();
        user1.setUsername(CUSTOMER1_ID);
        user1.setPassword(CUSTOMER1_PASSWORD);
        user1.setAmountToWithdraw(CUSTOMER1_AMOUNT_TO_WITHDRAW);
        user1.setAmountToDepositInEuro(euroWithdraw);
        controller.submitWithdraw(user1);
        double CUSTOMER1_EXPECTED_BALANCE_AFTER_WITHDRAW = CUSTOMER1_BALANCE - CUSTOMER1_AMOUNT_TO_WITHDRAW;
        assertEquals(CUSTOMER1_EXPECTED_BALANCE_AFTER_WITHDRAW, user1.getBalance());
    }
}