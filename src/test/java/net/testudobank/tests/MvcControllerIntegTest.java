...
public void testTransferPaysOverdraftAndDepositsRemainder() throws SQLException, ScriptException { 
  ...
  public void testSimpleApplyInterest() throws SQLException, ScriptException {    
    ...
    for (int depositIdx = 0; depositIdx < amountsToDeposit.length; depositIdx++) {
      CUSTOMER1_AMOUNT_TO_DEPOSIT = amountsToDeposit[depositIdx]; 
      customer1DepositFormInputs.setAmountToDeposit(CUSTOMER1_AMOUNT_TO_DEPOSIT); 
    ...
    MvcControllerIntegTestHelpers.checkTransactionLog(customer1TransactionLog, timeWhenInterestIsApplied, CUSTOMER1_ID, MvcController.TRANSACTION_HISTORY_INTEREST_ACTION, CUSTOMER1_INTEREST_AMT_IN_PENNIES);
  }
