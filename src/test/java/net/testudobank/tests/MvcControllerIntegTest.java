...
public class MvcControllerIntegTest {
        ...
        /**
         * This test verifies that a customer accrues interest on their account after
         * making 5 deposits.
         * If the customer is in overdraft, they should not accrue interest
         * if the user has an empty balance they should nota accrue interest
         * 
         * @throws ScriptException
         */
        @Test
        public void testInterestAppliedAfter5Deposits() throws ScriptException {
                // initialize customer1 with a balance of $123.45 (to make sure this works for
                // non-whole dollar amounts). represented as pennies in the DB.
                double CUSTOMER1_BALANCE = 505.45;
                int CUSTOMER1_BALANCE_IN_PENNIES = MvcControllerIntegTestHelpers
                                .convertDollarsToPennies(CUSTOMER1_BALANCE);
                MvcControllerIntegTestHelpers.addCustomerToDB(dbDelegate, CUSTOMER1_ID, CUSTOMER1_PASSWORD,
                                CUSTOMER1_FIRST_NAME,
                ...
                // send request to the Deposit Form's POST handler in MvcController
                // deposit 5 times
                double deposits[] = { 22.34, 23.34, 24.34, 25.34, 26.34 };

                MvcControllerIntegTestHelpers.makeDeposits(controller, customer1DepositFormInputs, deposits);

                // verify that number of interest deposits is equal to 5
                ...
                assertEquals(63656, userBalanceInPennies);
        }

        /**
         * This test verifies that a customer doesnt accrue interest if paying below $20
         * 
         * @throws ScriptException
         */
