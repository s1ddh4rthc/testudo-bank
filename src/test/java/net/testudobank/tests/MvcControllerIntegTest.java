...
public class MvcControllerIntegTest {
    ...
    /**
     * Test sample user flow of ETH and SOL buy transactions and a SOL sell
     * transaction
     */
    @Test
    public void testCryptoTransactionUserFlow() throws ScriptException {
        ...
        CryptoTransactionTester cryptoTransactionBuySOLAfterETHTransactionTester = CryptoTransactionTester.builder()
                .initialBalanceInDollars(900)
                .initialCryptoBalance(Collections.singletonMap("ETH", 0.1))
                .build();

        cryptoTransactionBuySOLAfterETHTransactionTester.initialize();

        CryptoTransaction BuySOLAfterETHTransaction = CryptoTransaction.builder()
        ...
        cryptoTransactionBuySOLAfterETHTransactionTester.test(BuySOLAfterETHTransaction);
         clearDB();

        CryptoTransactionTester cryptoTransactionSellSOLTester = CryptoTransactionTester.builder()
                .initialBalanceInDollars(800)
                .initialCryptoBalance(Collections.singletonMap("SOL", 0.1))
                .build();

        cryptoTransactionSellSOLTester.initialize();
        ...
        cryptoTransactionSellSOLTester.test(SellSOLTransaction);
    }

    /* Test that BTC BUY transactions fail and that the welcome page is returned */
    @Test
    public void testBuyBTC() throws ScriptException {
        ...
        String responsePage = controller.buyCrypto(user);
        assertEquals("welcome", responsePage);
    }

    /* Test that BTC SELL transactions fail and that the welcome page is returned */
    @Test
    public void testSELLBTC() throws ScriptException {
        ...
        user.setWhichCryptoToBuy(cryptoTransaction.cryptoName);
        user.setAmountToBuyCrypto(cryptoTransaction.cryptoAmountToTransact);
        String responsePage = controller.sellCrypto(user);
        assertEquals("welcome", responsePage);
    }
