...
public class MvcControllerIntegTest {
    ...
    public void testSimpleWithdraw() throws SQLException, ScriptException {
        ...
        customer1WithdrawFormInputs.setAmountToWithdraw(CUSTOMER1_AMOUNT_TO_WITHDRAW); // user input is in dollar
                                                                                       // amount,
                                                                                       // not pennies.
    ...
    static class CryptoTransactionTester {
        ...
        void test(CryptoTransaction transaction) {
            ...
            assertEquals(
                    MvcControllerIntegTestHelpers.convertDollarsToPennies(transaction.expectedEndingBalanceInDollars),
                    jdbcTemplate.queryForObject("SELECT Balance FROM Customers WHERE CustomerID=?", Integer.class,
                            CUSTOMER1_ID));
            ...
            assertEquals(
                    ...
                    jdbcTemplate.queryForObject("SELECT OverdraftBalance FROM Customers WHERE CustomerID=?",
                            Integer.class,
                            CUSTOMER1_ID));
            ...
            if (!transaction.shouldSucceed) {
                ...
                MvcControllerIntegTestHelpers.checkTransactionLog(customer1TransactionLog, cryptoTransactionTime,
                        CUSTOMER1_ID,
                ...
                if (transaction.overdraftTransaction) {
                    ...
                    MvcControllerIntegTestHelpers.checkOverdraftLog(customer1OverdraftLog, cryptoTransactionTime,
                            CUSTOMER1_ID,
                            expectedCryptoValueInPennies,
                            MvcControllerIntegTestHelpers
                                    .convertDollarsToPennies(transaction.initialOverdraftBalanceInDollars),
                            MvcControllerIntegTestHelpers
                                    .convertDollarsToPennies(transaction.expectedEndingOverdraftBalanceInDollars));
    ...
    static class SP500TransactionTester {
        ...
        void test(SP500Transaction transaction) {
            ...
            if (!transaction.shouldSucceed) {
                ...
                MvcControllerIntegTestHelpers.checkTransactionLog(customer1TransactionLog, SP500TransactionTime,
                        CUSTOMER1_ID,
                ...
                if (transaction.overdraftTransaction) {
                    ...
                    List<Map<String, Object>> overdraftLogTableData = jdbcTemplate
                            .queryForList("SELECT * FROM OverdraftLogs ORDER BY Timestamp DESC;");
                    Map<String, Object> customer1OverdraftLog = overdraftLogTableData.get(0);
                    MvcControllerIntegTestHelpers.checkOverdraftLog(customer1OverdraftLog, SP500TransactionTime,
                            CUSTOMER1_ID,
    ...
    /**
     * Test that attempting to sell a cryptocurrency that is not supported (BTC)
     * will
     * return the "welcome" page.
     */
    @Test
    ...
    public void testSP500BuyInvalidPassword() throws ScriptException {
        SP500TransactionTester SP500TransactionTester = net.testudobank.tests.MvcControllerIntegTest.SP500TransactionTester.builder()
                .initialBalanceInDollars(1000)
                .build();

        SP500TransactionTester.initialize();

        SP500Transaction SP500Transaction = net.testudobank.tests.MvcControllerIntegTest.SP500Transaction.builder()
                .expectedEndingBalanceInDollars(1000)
                .SP500Price(1000)
    ...
    public void testSP500BuySimple() throws ScriptException {
        SP500TransactionTester SP500TransactionTester = net.testudobank.tests.MvcControllerIntegTest.SP500TransactionTester
                .builder()
                .initialBalanceInDollars(1000)
                .initialSP500Balance(0.0)
                .build();
     ...
     */
    @Test
    public void testDepositIncrementsNumDepositsForInterest() throws SQLException, ScriptException {
        // initialize customer1 with an balance of 0.
        int CUSTOMER1_MAIN_BALANCE_IN_PENNIES = 0;
        int CUSTOMER1_OVERDRAFT_BALANCE_IN_PENNIES = 0;
        int CUSTOMER1_NUM_FRAUD_REVERSALS = 0;
        MvcControllerIntegTestHelpers.addCustomerToDB(dbDelegate, CUSTOMER1_ID, CUSTOMER1_PASSWORD,
        ...
        // verify that the customer's main balance is $20.01
        Map<String, Object> customer1Data = customersTableData.get(0);
        int CUSTOMER1_EXPECTED_MAIN_BALANCE_IN_PENNIES = MvcControllerIntegTestHelpers
                .convertDollarsToPennies(CUSTOMER1_AMOUNT_TO_DEPOSIT);
        assertEquals(CUSTOMER1_EXPECTED_MAIN_BALANCE_IN_PENNIES, (int) customer1Data.get("Balance"));

        // verify that the customer's numDepositsForInterest is 1
        int CUSTOMER1_EXPECTED_NUM_DEPOSITS_FOR_INTEREST = 1;
        assertEquals(CUSTOMER1_EXPECTED_NUM_DEPOSITS_FOR_INTEREST, (int) customer1Data.get("NumDepositsForInterest"));
    ...
    /**
     * Verifies the case where a customer deposits an amount
     * that is less than $20 that does not increment numDepositsForInterest.
     * 
     * This Deposit should still be recorded in the TransactionHistory table.
     * 
     * @throws SQLException
     ...
     */
    @Test
    public void testSmallDepositDoesNotIncrementNumDepositsForInterest() throws SQLException, ScriptException {
        // initialize customer1 with an balance of 0.
        int CUSTOMER1_MAIN_BALANCE_IN_PENNIES = 0;
        int CUSTOMER1_OVERDRAFT_BALANCE_IN_PENNIES = 0;
        int CUSTOMER1_NUM_FRAUD_REVERSALS = 0;
     ...
     */
    @Test
    public void testMultipleDepositsIncrementNumDepositsForInterest() throws SQLException, ScriptException {
        // initialize customer1 with an balance of 0.
        int CUSTOMER1_MAIN_BALANCE_IN_PENNIES = 0;
        int CUSTOMER1_OVERDRAFT_BALANCE_IN_PENNIES = 0;
        int CUSTOMER1_NUM_FRAUD_REVERSALS = 0;
        ...
        // fetch updated data from the DB
        List<Map<String, Object>> customersTableData = jdbcTemplate.queryForList("SELECT * FROM Customers;");
        // verify that the customer's main balance is $40.02
        Map<String, Object> customer1Data = customersTableData.get(0);
        int CUSTOMER1_EXPECTED_MAIN_BALANCE_IN_PENNIES = MvcControllerIntegTestHelpers
                .convertDollarsToPennies(CUSTOMER1_AMOUNT_TO_DEPOSIT * 2);
        assertEquals(CUSTOMER1_EXPECTED_MAIN_BALANCE_IN_PENNIES, (int) customer1Data.get("Balance"));

        // verify that the customer's numDepositsForInterest is 2
        int CUSTOMER1_EXPECTED_NUM_DEPOSITS_FOR_INTEREST = 2;
        assertEquals(CUSTOMER1_EXPECTED_NUM_DEPOSITS_FOR_INTEREST, (int) customer1Data.get("NumDepositsForInterest"));

    }

    /**
     * Verifies the case where a customer deposits 5 amounts
     * that increment numDepositsForInterest, and 1.5% interest
     * is deposited.
     * 
     * This Deposit and the Interest should be recorded in the TransactionHistory
     * table.
     * 
     * @throws SQLException
     * @throws ScriptException
     */
    @Test
    public void testInterestAccruesAfterMultipleDeposits() throws SQLException, ScriptException {
        // initialize customer1 with an balance of 0.
        int CUSTOMER1_MAIN_BALANCE_IN_PENNIES = 0;
        int CUSTOMER1_OVERDRAFT_BALANCE_IN_PENNIES = 0;
        int CUSTOMER1_NUM_FRAUD_REVERSALS = 0;
        ...
        // Prepare Deposit Form to Deposit $25 to customer 1's account.
        double CUSTOMER1_AMOUNT_TO_DEPOSIT = 25; // user input is in dollar amount, not pennies.
        User customer1DepositFormInputs = new User();
        customer1DepositFormInputs.setUsername(CUSTOMER1_ID);
        customer1DepositFormInputs.setPassword(CUSTOMER1_PASSWORD);
        customer1DepositFormInputs.setAmountToDeposit(CUSTOMER1_AMOUNT_TO_DEPOSIT);

        // send request 5x to the Deposit Form's POST handler in MvcController
        controller.submitDeposit(customer1DepositFormInputs);
        controller.submitDeposit(customer1DepositFormInputs);
        controller.submitDeposit(customer1DepositFormInputs);
        controller.submitDeposit(customer1DepositFormInputs);
        ...
        // verify that the customer's numDepositsForInterest is reset back to 0
        Map<String, Object> customer1Data = customersTableData.get(0);
        int CUSTOMER1_EXPECTED_NUM_DEPOSITS_FOR_INTEREST = 0;
        assertEquals(CUSTOMER1_EXPECTED_NUM_DEPOSITS_FOR_INTEREST, (int) customer1Data.get("NumDepositsForInterest"));

        // verify that the customer's main balance is correct

        int CUSTOMER1_EXPECTED_BALANCE_IN_PENNIES = MvcControllerIntegTestHelpers
                .convertDollarsToPennies(CUSTOMER1_AMOUNT_TO_DEPOSIT * 5);
        int CUSTOMER1_EXPECTED_MAIN_BALANCE_IN_PENNIES = (int) (CUSTOMER1_EXPECTED_BALANCE_IN_PENNIES * 1.015);
        assertEquals(CUSTOMER1_EXPECTED_MAIN_BALANCE_IN_PENNIES, (int) customer1Data.get("Balance"));
    }

    /**
     * Test the user flow of buying S&P500, and then selling.
     */
    @Test
    public void testBuySellSP500UserFlow() throws ScriptException {
        SP500TransactionTester tester = net.testudobank.tests.MvcControllerIntegTest.SP500TransactionTester.builder()
                .initialBalanceInDollars(1000)
                .initialSP500Balance(0.0)
                .build();
        ...
        tester.initialize();
        // Buy SP500
        SP500Transaction buy = net.testudobank.tests.MvcControllerIntegTest.SP500Transaction.builder()
                .expectedEndingBalanceInDollars(900)
                .expectedEndingSP500Balance(0.1)
                .SP500Price(1000)
                .SP500AmountToTransact(0.1)
        ...
        // Sell some SP500
        SP500Transaction sell = net.testudobank.tests.MvcControllerIntegTest.SP500Transaction.builder()
                .expectedEndingBalanceInDollars(890)
