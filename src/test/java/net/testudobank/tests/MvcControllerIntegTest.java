...
public class MvcControllerIntegTest {
        ...
        public void testSimpleDeposit() throws SQLException, ScriptException {
                ...
                MvcControllerIntegTestHelpers.addCustomerToDB(dbDelegate, CUSTOMER1_ID, CUSTOMER1_PASSWORD,
                                CUSTOMER1_FIRST_NAME, CUSTOMER1_LAST_NAME, CUSTOMER1_BALANCE_IN_PENNIES, 0);
                ...
                MvcControllerIntegTestHelpers.checkTransactionLog(customer1TransactionLog, timeWhenDepositRequestSent,
                                CUSTOMER1_ID, MvcController.TRANSACTION_HISTORY_DEPOSIT_ACTION,
        ...
        public void testSimpleWithdraw() throws SQLException, ScriptException {
                ...
                customer1WithdrawFormInputs.setAmountToWithdraw(CUSTOMER1_AMOUNT_TO_WITHDRAW); // user input is in
                                                                                               // dollar amount, not
                                                                                               // pennies.
                ...
                MvcControllerIntegTestHelpers.checkTransactionLog(customer1TransactionLog, timeWhenWithdrawRequestSent,
                                CUSTOMER1_ID, MvcController.TRANSACTION_HISTORY_WITHDRAW_ACTION,
                                CUSTOMER1_AMOUNT_TO_WITHDRAW_IN_PENNIES);
        }
        ...
        public void testWithdrawTriggersOverdraft() throws SQLException, ScriptException {
                ...
                int CUSTOMER1_EXPECTED_OVERDRAFT_BALANCE_AFTER_INTEREST_IN_PENNIES = MvcControllerIntegTestHelpers
                                .applyOverdraftInterest(
                                                CUSTOMER1_EXPECTED_OVERDRAFT_BALANCE_BEFORE_INTEREST_IN_PENNIES);
                System.out.println("Expected Overdraft Balance in pennies: "
                                + CUSTOMER1_EXPECTED_OVERDRAFT_BALANCE_AFTER_INTEREST_IN_PENNIES);
        ...
        public void testDepositOverdraftClearedWithExcess() throws SQLException, ScriptException {
                ...
                MvcControllerIntegTestHelpers.addCustomerToDB(dbDelegate, CUSTOMER1_ID, CUSTOMER1_PASSWORD,
                                CUSTOMER1_FIRST_NAME, CUSTOMER1_LAST_NAME, CUSTOMER1_MAIN_BALANCE_IN_PENNIES,
                                CUSTOMER1_OVERDRAFT_BALANCE_IN_PENNIES, CUSTOMER1_NUM_FRAUD_REVERSALS, 0);
                ...
                List<Map<String, Object>> transactionHistoryTableData = jdbcTemplate
                                .queryForList("SELECT * FROM TransactionHistory;");
                List<Map<String, Object>> overdraftLogsTableData = jdbcTemplate
                                .queryForList("SELECT * FROM OverdraftLogs;");
                ...
                MvcControllerIntegTestHelpers.checkOverdraftLog(customer1OverdraftLog, timeWhenDepositRequestSent,
                                CUSTOMER1_ID, CUSTOMER1_AMOUNT_TO_DEPOSIT_IN_PENNIES,
                                CUSTOMER1_ORIGINAL_OVERDRAFT_BALANCE_IN_PENNIES, 0);
        ...
        public void testDepositOverdraftNotCleared() throws SQLException, ScriptException {
                ...
                int CUSTOMER1_EXPECTED_FINAL_OVERDRAFT_BALANCE_IN_PENNIES = CUSTOMER1_ORIGINAL_OVERDRAFT_BALANCE_IN_PENNIES
                                - CUSTOMER1_AMOUNT_TO_DEPOSIT_IN_PENNIES;
                assertEquals(CUSTOMER1_EXPECTED_FINAL_OVERDRAFT_BALANCE_IN_PENNIES,
                                (int) customer1Data.get("OverdraftBalance"));
        ...
        public void testReversalOfSimpleDeposit() throws SQLException, ScriptException, InterruptedException {
                ...
                int CUSTOMER1_AMOUNT_TO_DEPOSIT_IN_PENNIES = MvcControllerIntegTestHelpers
                                .convertDollarsToPennies(CUSTOMER1_AMOUNT_TO_DEPOSIT);
                MvcControllerIntegTestHelpers.checkTransactionLog(customer1DepositTransactionLog,
                                timeWhenDepositRequestSent, CUSTOMER1_ID,
                                MvcController.TRANSACTION_HISTORY_DEPOSIT_ACTION,
                                CUSTOMER1_AMOUNT_TO_DEPOSIT_IN_PENNIES);
                ...
                MvcControllerIntegTestHelpers.checkTransactionLog(customer1ReversalTransactionLog,
                                timeWhenReversalRequestSent, CUSTOMER1_ID,
                                MvcController.TRANSACTION_HISTORY_WITHDRAW_ACTION,
                                CUSTOMER1_AMOUNT_TO_WITHDRAW_IN_PENNIES);
        }
        ...
        public void testReversalOfSimpleWithdraw() throws SQLException, ScriptException, InterruptedException {
                ...
                int CUSTOMER1_AMOUNT_TO_WITHDRAW_IN_PENNIES = MvcControllerIntegTestHelpers
                                .convertDollarsToPennies(CUSTOMER1_AMOUNT_TO_WITHDRAW);
                MvcControllerIntegTestHelpers.checkTransactionLog(customer1WithdrawTransactionLog,
                                timeWhenWithdrawRequestSent, CUSTOMER1_ID,
                                MvcController.TRANSACTION_HISTORY_WITHDRAW_ACTION,
                                CUSTOMER1_AMOUNT_TO_WITHDRAW_IN_PENNIES);
        ...
        public void testFrozenAccount() throws SQLException, ScriptException, InterruptedException {
                ...
                customer1FrozenFormInputs
                                .setAmountToWithdraw(MvcControllerIntegTestHelpers.convertDollarsToPennies(50));
         ...
         */
        @Test
        public void testReverseDepositExceedsOverdraftLimit()
                ...
                // should be the Deposit
                transactionHistoryTableData = jdbcTemplate
                                .queryForList("SELECT * FROM TransactionHistory ORDER BY Timestamp ASC;");
        ...
        public void testTransfer() throws SQLException, ScriptException {
                ...
                MvcControllerIntegTestHelpers.addCustomerToDB(dbDelegate, CUSTOMER2_ID, CUSTOMER2_PASSWORD,
                                CUSTOMER2_FIRST_NAME, CUSTOMER2_LAST_NAME, CUSTOMER2_BALANCE_IN_PENNIES, 0);
                ...
                List<Map<String, Object>> customer1SqlResult = jdbcTemplate.queryForList(
                                String.format("SELECT * FROM Customers WHERE CustomerID='%s';", CUSTOMER1_ID));
                Map<String, Object> customer1Data = customer1SqlResult.get(0);

                List<Map<String, Object>> customer2SqlResult = jdbcTemplate.queryForList(
                                String.format("SELECT * FROM Customers WHERE CustomerID='%s';", CUSTOMER2_ID));
                Map<String, Object> customer2Data = customer2SqlResult.get(0);

                // Verify that customer1's balance decreased by $100.
                assertEquals((CUSTOMER1_BALANCE_IN_PENNIES - TRANSFER_AMOUNT_IN_PENNIES),
                                (int) customer1Data.get("Balance"));

                // Verify that customer2's balance increased by $100.
                assertEquals((CUSTOMER2_BALANCE_IN_PENNIES + TRANSFER_AMOUNT_IN_PENNIES),
                                (int) customer2Data.get("Balance"));
        ...
        public void testTransferPaysOffOverdraftBalance() throws SQLException, ScriptException {
                ...
                MvcControllerIntegTestHelpers.addCustomerToDB(dbDelegate, CUSTOMER2_ID, CUSTOMER2_PASSWORD,
                                CUSTOMER2_FIRST_NAME, CUSTOMER2_LAST_NAME, CUSTOMER2_BALANCE_IN_PENNIES,
                                CUSTOMER2_OVERDRAFT_BALANCE_IN_PENNIES, CUSTOMER2_NUM_FRAUD_REVERSALS, 0);
        ...
        public void testTransferPaysOverdraftAndDepositsRemainder() throws SQLException, ScriptException {
                ...
                int CUSTOMER2_EXPECTED_BALANCE_IN_PENNIES = TRANSFER_AMOUNT_IN_PENNIES
                                - CUSTOMER2_OVERDRAFT_BALANCE_IN_PENNIES;
        ...
        static class CryptoTransactionTester {
                ...
                void initialize() throws ScriptException {
                        ...
                        MvcControllerIntegTestHelpers.addCustomerToDB(dbDelegate, CUSTOMER1_ID, CUSTOMER1_PASSWORD,
                                        CUSTOMER1_FIRST_NAME,
                                        CUSTOMER1_LAST_NAME, balanceInPennies, MvcControllerIntegTestHelpers
                                                        .convertDollarsToPennies(initialOverdraftBalanceInDollars),
                                        0, 0);
                        for (Map.Entry<String, Double> initialBalance : initialCryptoBalance.entrySet()) {
                                MvcControllerIntegTestHelpers.setCryptoBalance(dbDelegate, CUSTOMER1_ID,
                                                initialBalance.getKey(), initialBalance.getValue());
                        }
                }
                ...
                void test(CryptoTransaction transaction) {
                        ...
                        Mockito.when(cryptoPriceClient.getCurrentCryptoValue(transaction.cryptoName))
                                        .thenReturn(transaction.cryptoPrice);
                        ...
                        try {
                                double endingCryptoBalance = jdbcTemplate.queryForObject(
                                                "SELECT CryptoAmount FROM CryptoHoldings WHERE CustomerID=? AND CryptoName=?",
                                                BigDecimal.class, CUSTOMER1_ID, transaction.cryptoName).doubleValue();
                        ...
                        assertEquals(MvcControllerIntegTestHelpers
                                        .convertDollarsToPennies(transaction.expectedEndingBalanceInDollars),
                                        jdbcTemplate.queryForObject("SELECT Balance FROM Customers WHERE CustomerID=?",
                                                        Integer.class, CUSTOMER1_ID));
                        ...
                        if (!transaction.shouldSucceed) {
                                ...
                                assertEquals(numTransactions, jdbcTemplate.queryForObject(
                                                "SELECT COUNT(*) FROM TransactionHistory;", Integer.class));
                                assertEquals(numTransactions, jdbcTemplate
                                                .queryForObject("SELECT COUNT(*) FROM CryptoHistory;", Integer.class));
                                assertEquals(numOverdraftTransactions, jdbcTemplate
                                                .queryForObject("SELECT COUNT(*) FROM OverdraftLogs;", Integer.class));
                        } else {
                                assertEquals("account_info", returnedPage);

                                // check transaction logs
                                assertEquals(numTransactions + 1, jdbcTemplate.queryForObject(
                                                "SELECT COUNT(*) FROM TransactionHistory;", Integer.class));
                                List<Map<String, Object>> transactionHistoryTableData = jdbcTemplate.queryForList(
                                                "SELECT * FROM TransactionHistory ORDER BY Timestamp DESC;");
                                Map<String, Object> customer1TransactionLog = transactionHistoryTableData.get(0);
                                int expectedCryptoValueInPennies = MvcControllerIntegTestHelpers
                                                .convertDollarsToPennies(transaction.cryptoPrice
                                                                * transaction.cryptoAmountToTransact);
                                MvcControllerIntegTestHelpers.checkTransactionLog(customer1TransactionLog,
                                                cryptoTransactionTime, CUSTOMER1_ID,
                                                transaction.cryptoTransactionTestType.transactionHistoryActionName,
                                                expectedCryptoValueInPennies);

                                // check crypto logs
                                assertEquals(numTransactions + 1, jdbcTemplate
                                                .queryForObject("SELECT COUNT(*) FROM CryptoHistory;", Integer.class));
                                ...
                                MvcControllerIntegTestHelpers.checkCryptoLog(customer1CryptoLog, cryptoTransactionTime,
                                                CUSTOMER1_ID,
                                ...
                                if (transaction.overdraftTransaction) {
                                        assertEquals(numOverdraftTransactions + 1, jdbcTemplate.queryForObject(
                                                        "SELECT COUNT(*) FROM OverdraftLogs;", Integer.class));
                                        List<Map<String, Object>> overdraftLogTableData = jdbcTemplate.queryForList(
                                                        "SELECT * FROM OverdraftLogs ORDER BY Timestamp DESC;");
                                        ...
                                        assertEquals(numOverdraftTransactions, jdbcTemplate.queryForObject(
                                                        "SELECT COUNT(*) FROM OverdraftLogs;", Integer.class));
                                }
        ...
        /**
         * Test that user is succesfully able to buy ETH, SOL, and sell SOL
         */
        @Test
        public void testBuyAndSellCrypto() throws ScriptException {
                ...
                CryptoTransaction transaction1 = CryptoTransaction.builder()
                                .expectedEndingBalanceInDollars(994)
                ...
                cryptoTransactionTester1.test(transaction1); // buying ETH should work
                ...
                CryptoTransaction transactionSol = CryptoTransaction.builder()
                                .expectedEndingBalanceInDollars(1500)
                                .expectedEndingCryptoBalance(250.0)
                                .cryptoPrice(2)
                                .cryptoAmountToTransact(250.0)
                                .cryptoName("SOL")
                                .cryptoTransactionTestType(CryptoTransactionTestType.BUY)
                                .shouldSucceed(true)
                                .build();

                cryptoTransactionTester2.test(transactionSol);// buying SOL should work

                //
                CryptoTransactionTester cryptoTransactionTester3 = CryptoTransactionTester.builder()
                                .initialBalanceInDollars(1500)
                                .initialCryptoBalance(Collections.singletonMap("SOL", 250.0))
                                .build();

                cryptoTransactionTester3.initialize();

                // transaction to sell SOL
                CryptoTransaction transactionSellSol = CryptoTransaction.builder()
                                .expectedEndingBalanceInDollars(2500)
                                .expectedEndingCryptoBalance(0.0)
                                .cryptoPrice(4)
                                .cryptoAmountToTransact(250)
                                .cryptoName("SOL")
                                .cryptoTransactionTestType(CryptoTransactionTestType.SELL)
                                .shouldSucceed(true)
                                .build();

                cryptoTransactionTester3.test(transactionSellSol);// selling SOL should work

        }

        // ensures welcome page is return when buying crypto that is not yet supported
        @Test
        public void testInvalidBitcoinTransactionBuy() throws ScriptException {
                CryptoTransactionTester cryptoTransactionTester1 = CryptoTransactionTester.builder()
                                .initialBalanceInDollars(1000)
                ...
                CryptoTransaction transactionBuyBitcoin = CryptoTransaction.builder()
                                .expectedEndingBalanceInDollars(1000)
                                .expectedEndingCryptoBalance(0)
                                .cryptoPrice(3)
                                .cryptoAmountToTransact(2)
                ...
                cryptoTransactionTester1.test(transactionBuyBitcoin); // buying bitcoin should not work and return
                                                                      // welcome page

        }

        // ensures welcome page is return when selling crypto that is not yet supported
        @Test
        public void testInvalidBitcoinTransactionSell() throws ScriptException {
                CryptoTransactionTester cryptoTransactionTester1 = CryptoTransactionTester.builder()
                                .initialBalanceInDollars(1000)
                ...
                CryptoTransaction transactionSellBitcoin = CryptoTransaction.builder()
                                .expectedEndingBalanceInDollars(1000)
                ...
                cryptoTransactionTester1.test(transactionSellBitcoin); // buying bitcoin should not work and return
                                                                       // welcome page
