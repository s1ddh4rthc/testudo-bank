...
public class MvcControllerIntegTest {
   ...
   */
  @Test
  public void testInterestApplyOnSixDeposits() throws SQLException, ScriptException {
    ...
    // Assert there are only 7 transactions (6 deposits and 1 interest application)
  ...
  public void testInterestApplyOnDepositAmounts() throws SQLException, ScriptException {
    ...
    // NumDeposits stays 0 since deposit under twenty
    customer1DepositFormInputs.setAmountToDeposit(CUSTOMER1_UNDER_TWENTY_DEPOSIT);
    controller.submitDeposit(customer1DepositFormInputs);
    assertEquals(0, jdbcTemplate.queryForObject(numDepositsForInterestQuery, Integer.class));

    // NumDeposits increases by 1 since deposit over twenty
    customer1DepositFormInputs.setAmountToDeposit(CUSTOMER1_OVER_TWENTY_DEPOSIT);
    controller.submitDeposit(customer1DepositFormInputs);
    assertEquals(1, jdbcTemplate.queryForObject(numDepositsForInterestQuery, Integer.class));

    // NumDeposits increases by 1 since deposit equals twenty
