...
public void testTransferPaysOverdraftAndDepositsRemainder() throws SQLException, ScriptException { 
  ...
  /**
   * Tests whether interest is actually applied after 5 or more $20 or greater
   * deposits
   * 
   * @throws SQLException
   * @throws ScriptException
   */
  @Test
  public void testApplyIntrestAfter5Deposits() throws SQLException, ScriptException {
    ...
    // verify customer balance was increased by 5 deposits of $20.01 and multiplied by the interest rate
    int NUMBER_OF_DEPOSITS = 5;
    double INTEREST_RATE = 1.015;
    double CUSTOMER1_EXPECTED_FINAL_BALANCE = (CUSTOMER1_BALANCE + (NUMBER_OF_DEPOSITS * CUSTOMER1_AMOUNT_TO_DEPOSIT)) * INTEREST_RATE;
    double CUSTOMER1_EXPECTED_FINAL_BALANCE_IN_PENNIES = MvcControllerIntegTestHelpers.convertDollarsToPennies(CUSTOMER1_EXPECTED_FINAL_BALANCE);
    assertEquals(CUSTOMER1_EXPECTED_FINAL_BALANCE_IN_PENNIES, (int) customer1Data.get("Balance"));

    // verify that the 5 Deposit and amount of interest gained are logged in TransactionHistory table
  ...
  /**
   * 
   * Tests to make sure there is no interest applied since all deposits are less than $20
   * 
   * @throws SQLException
   * @throws ScriptException
   */
  @Test
  public void testNoIntrestAppliedAForDepositsLessThan20() throws SQLException, ScriptException {
    ...
    // verify customer balance was increased by 5 deposits of $19.99 
    int NUMBER_OF_DEPOSITS = 5;
    double CUSTOMER1_EXPECTED_FINAL_BALANCE = (CUSTOMER1_BALANCE + (NUMBER_OF_DEPOSITS * CUSTOMER1_AMOUNT_TO_DEPOSIT));
    double CUSTOMER1_EXPECTED_FINAL_BALANCE_IN_PENNIES = MvcControllerIntegTestHelpers.convertDollarsToPennies(CUSTOMER1_EXPECTED_FINAL_BALANCE);
    assertEquals(CUSTOMER1_EXPECTED_FINAL_BALANCE_IN_PENNIES, (int) customer1Data.get("Balance"));

    // verify that the 5 Deposit and amount of interest gained are logged in
    // TransactionHistory table
  ...
  /**
   * This test makes 6 deposits over $20 to make sure no interest is applied after the 5th deposit
   * 
   * @throws SQLException
   * @throws ScriptException
   */
  ...
  public void testIntrestNotAppliedAfter5thDepositLessThanMinimum() throws SQLException, ScriptException {
    ...
    // send request to the Deposit Form's POST handler in MvcController 6 times
    controller.submitDeposit(customer1DepositFormInputs);
    controller.submitDeposit(customer1DepositFormInputs);
    controller.submitDeposit(customer1DepositFormInputs);
    controller.submitDeposit(customer1DepositFormInputs);
    ...
    // verify customer balance was increased by 6 deposits of $20.01 and multiplied
    // by the interest rate but before the 6th deposit 
    int NUMBER_OF_DEPOSITS_BEFORE_INTEREST = 5;
    double INTEREST_RATE = 1.015;
    double CUSTOMER1_EXPECTED_FINAL_BALANCE = (CUSTOMER1_BALANCE + (NUMBER_OF_DEPOSITS_BEFORE_INTEREST * CUSTOMER1_AMOUNT_TO_DEPOSIT)) * INTEREST_RATE;
    CUSTOMER1_EXPECTED_FINAL_BALANCE += CUSTOMER1_AMOUNT_TO_DEPOSIT; // ADD 6th Deposit
    double CUSTOMER1_EXPECTED_FINAL_BALANCE_IN_PENNIES = MvcControllerIntegTestHelpers.convertDollarsToPennies(CUSTOMER1_EXPECTED_FINAL_BALANCE);
    assertEquals(CUSTOMER1_EXPECTED_FINAL_BALANCE_IN_PENNIES, (int) customer1Data.get("Balance"));

    // verify that the 7 Deposit and amount of interest gained are logged in
    // TransactionHistory table
  ...
  /**
   * This test makes sure no interest is applied to customers balance if they have
   * overdraft
   * 
   * @throws SQLException
   * @throws ScriptException
   */
  @Test
  public void testNoIntrestAppliedAForWhenOverdraft() throws SQLException, ScriptException {

    // initialize customer1 with a balance of $100 and Overdraft of $123.45
    double CUSTOMER1_BALANCE = 100.0;
    int CUSTOMER1_BALANCE_IN_PENNIES = MvcControllerIntegTestHelpers.convertDollarsToPennies(CUSTOMER1_BALANCE);
    double CUSTOMER1_OVERDRAFT_BALANCE = 123.45;
    int CUSTOMER1_OVERDRAFT_BALANCE_IN_PENNIES = MvcControllerIntegTestHelpers.convertDollarsToPennies(CUSTOMER1_OVERDRAFT_BALANCE);
    int CUSTOMER1_NUM_INTEREST_DEPOSITS = 0;
    MvcControllerIntegTestHelpers.addCustomerToDB(dbDelegate, CUSTOMER1_ID, CUSTOMER1_PASSWORD, CUSTOMER1_FIRST_NAME, CUSTOMER1_LAST_NAME, CUSTOMER1_BALANCE_IN_PENNIES, CUSTOMER1_OVERDRAFT_BALANCE_IN_PENNIES, CUSTOMER1_NUM_INTEREST_DEPOSITS, 0);
    ...
    // verify customer balance was not increased at all due to overdraft
    double CUSTOMER1_EXPECTED_FINAL_BALANCE = CUSTOMER1_BALANCE ;
    double CUSTOMER1_EXPECTED_FINAL_BALANCE_IN_PENNIES = MvcControllerIntegTestHelpers.convertDollarsToPennies(CUSTOMER1_EXPECTED_FINAL_BALANCE);
    assertEquals(CUSTOMER1_EXPECTED_FINAL_BALANCE_IN_PENNIES, (int) customer1Data.get("Balance"));

    // verify that the 5 Deposit and are logged in TransactionHistory table
    assertEquals(5, transactionHistoryTableData.size());
