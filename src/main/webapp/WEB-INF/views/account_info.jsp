...
<body>
    ...
    <span>S&P500 Balance in USD: $</span><span>${user.SP500Balance}</span><br/>
    ...
    <span>Current S&P500 Price: </span><span>${user.SP500Price}</span><br/>
    ...
    <span>S&P500 History: </span><span>${user.SP500Hist}</span><br/>
    <br/>
