...
<body>
    <div align="center">
        ...
        <h3>Ensure that your balance is over $200, that you have no outstanding loans and that your requested loan amount is less than your current account balance.</h3>
