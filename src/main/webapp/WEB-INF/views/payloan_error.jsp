...
<body>
    <div align="center">
        ...
        <h3>Make sure that you have an outstanding loan and that the requested repayment amount is less than your current account balance.</h3>
