        ...
        <body>
            <div align="center">
                <form:form action="sell" method="post" modelAttribute="user">
                    ...
                    <form:label path="whichStockToSell">Which Stock to sell (Type ticker symbol):</form:label>
                    <form:input path="whichStockToSell" /><br />

                    <form:label path="amountToSellStock">Amount of shares to sell (fractional allowed):</form:label>
