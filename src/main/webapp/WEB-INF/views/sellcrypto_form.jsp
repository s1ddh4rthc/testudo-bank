  ...
  <body>
    <div align="center">
      <form:form action="sellcrypto" method="post" modelAttribute="user">
        ...
        <form:label path="whichCryptoToBuy"
          >Which Crypto to buy (Type 'ETH' or 'SOL'):</form:label
        >
        <form:input path="whichCryptoToBuy" /><br />

        <form:label path="amountToSellCrypto"
          >Amount to buy (# of Coins, Fractional Allowed):</form:label
        >
