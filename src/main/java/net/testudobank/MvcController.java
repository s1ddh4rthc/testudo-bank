...
public class MvcController {
  ...
  private static int applyInterestRatetoPennies(int amtInPennies) {
    return (int) (amtInPennies * INTEREST_RATE);
  }
  ...
  public String submitWithdraw(@ModelAttribute("user") User user) {
    ...
    if (userWithdrawAmtInPennies > userBalanceInPennies) { // if withdraw amount exceeds main balance, withdraw into
      ...
      int newOverdraftIncreaseAmtAfterInterestInPennies = applyInterestRatetoPennies(excessWithdrawAmtInPennies);
