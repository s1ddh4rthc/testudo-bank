...
public class MvcController {
  ...
  /**
   * HTML GET request handler that serves the "savingslogin_form" page to the
   * user.
   * An empty `User` object is also added to the Model as an Attribute to store
   * the user's login form input.
   * 
  ...
  /**
   * HTML GET request handler that serves the "depositsavings_form" page to the
   * user.
   * An empty `User` object is also added to the Model as an Attribute to store
   * the user's deposit form input.
   * 
  ...
  /**
   * HTML GET request handler that serves the "withdrawsavings_form" page to the
   * user.
   * An empty `User` object is also added to the Model as an Attribute to store
   * the user's withdraw form input.
   * 
  ...
  /**
   * Helper method that queries the MySQL DB for the customer Savings account info
  ...
  /**
   * HTML POST request handler that uses user input from Savings' Login Form page
   * to determine
   * login success or failure.
   * 
   * Queries 'passwords' table in MySQL DB for the correct password associated
  ...
  public String submitSavingsDeposit(@ModelAttribute("user") User user) {
    ...
    int userSavingsDepositAmtInPennies = convertDollarsToPennies(userSavingsDepositAmt); // dollar amounts stored as
   ...
   * 
   * If the withdraw amount exceeds the user's current main savings balance, the
