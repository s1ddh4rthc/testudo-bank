...
public class TestudoBankRepository {
  ...
  public static int getCustomerCashSavingsBalanceInPennies(JdbcTemplate jdbcTemplate, String customerID) {
  ...
  public static void increaseCustomerCashSavingsBalance(JdbcTemplate jdbcTemplate, String customerID,
      int increaseAmtInPennies) {
    String balanceIncreaseSql = String.format(
        "UPDATE Customers SET SavingsBalance = SavingsBalance + %d WHERE CustomerID='%s';", increaseAmtInPennies,
        customerID);
    jdbcTemplate.update(balanceIncreaseSql);
  }
  ...
  public static void decreaseCustomerCashSavingsBalance(JdbcTemplate jdbcTemplate, String customerID,
      int decreaseAmtInPennies) {
    String balanceDecreaseSql = String.format(
        "UPDATE Customers SET SavingsBalance = SavingsBalance - %d WHERE CustomerID='%s';", decreaseAmtInPennies,
        customerID);
    jdbcTemplate.update(balanceDecreaseSql);
  }
